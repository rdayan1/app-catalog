...
describe 'Rally.apps.kanban.KanbanApp', ->
  ...
  it 'should show correct fields on cards', ->
    @createApp(cardFields: 'Name,Defects,Project').then =>
      ...
      expect(@cardboard.cardConfig.fields).toContain 'Name'
      expect(@cardboard.cardConfig.fields).toContain 'Defects'
      expect(@cardboard.cardConfig.fields).toContain 'Project'
  ...
  describe 'Swim Lanes is toggled ON', ->
    ...
    it 'should include correct rank sorter in manual rank workspace', ->
      ...
      ,
        ...
        expect(@cardboard.storeConfig.sorters).toEqual [
